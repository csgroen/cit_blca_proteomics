...
list(
    ...
    #-- Figure 4
    #----- (A) 
    tar_target(siFGFR3, siFGFR3_plot()),
    #----- (B)
    ...
    tar_target(apop_genes_sifgfr3, plot_siFGFR3_apoptPath()), # C
    tar_target(trail_birina, plot_trailBirina()), # E
    tar_target(fgfr3_rescue, plot_rescue_siFGFR3()), # Supp Fig Apoptosis
